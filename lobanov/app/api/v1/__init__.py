from lobanov.app.api.v1.audio.handlers import router as audio_router
from lobanov.app.api.v1.auth.handlers import router as auth_router
from lobanov.app.api.v1.documentation_session.handlers import router as session_router
