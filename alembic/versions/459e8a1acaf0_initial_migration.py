...
Revision ID: 459e8a1acaf0
Revises:
Create Date: 2026-04-22 23:44:12.802322+03:00
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["template_id"], ["medical_document_templates.id"], ondelete="RESTRICT"),
